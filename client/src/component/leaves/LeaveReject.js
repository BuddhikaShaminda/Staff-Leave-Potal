...
import {getReject} from '../../actions/leaveActions';
import Moment from 'react-moment';

class LeaveReject extends Component {
  componentDidMount(){
...
LeaveReject.propTypes ={
    getReject : PropTypes.func.isRequired,
...
export default connect(mapStateToProps,{getReject})(LeaveReject);